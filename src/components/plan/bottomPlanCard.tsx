        ...
        <div>
            ...
            <div className="flex md:hidden flex-col gap-4 pb-6 border-b border-gray-800 mb-5">
                ...
                <div className="flex flex-col gap-2 text-left">
                    ...
                    <button
                        className="w-full bg-lime-400 text-black px-5 py-2 rounded-full font-semibold flex justify-center gap-2 items-center hover:opacity-80 cursor-pointer"
            ...
            <div className="hidden md:flex justify-between items-center pb-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col justify-between text-left gap-2">
                        ...
                        <div className="flex mt-2 text-sm text-gray-300 gap-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        className="bg-lime-400 text-black px-5 py-2 rounded-full font-semibold flex gap-2 items-center hover:opacity-80 cursor-pointer"
                        onClick={handleButton}
                    >
                        <ImCheckmark />
                        <span>Mark as Done</span>
